...
int main() {
	...
	while(1) {
		...
		if (chucNang == 0) {
			...
			printf("Nhap C: ");
			if(scanf("%f", &giaTriThucHien) < 1) { // Giá tri. nhâp. vào phai? là 1 sô' thuc. (float); Nêu' ko se~ báo lôi~
				printf("=> Xuat hien loi khi nhap C. Vui long nhap lai !\n");
			} else {
			...
			printf("Nhap KW: ");
			if(scanf("%f", &giaTriThucHien) < 1) { // Giá tri. nhâp. vào phai? là 1 sô' thuc. (float); Nêu' ko se~ báo lôi~
				printf("=> Xuat hien loi khi nhap KW. Vui long nhap lai !\n");
			} else {
				tienDienLuyTien(giaTriThucHien);
			}
		} else if (chucNang == 3) {
			printf("Nhap so phan tu N: ");
			if(scanf("%d", &soPhanTu) < 1) { // Giá tri. nhâp. vào phai? là 1 sô' nguyên (int); Nêu' ko se~ báo lôi~
				printf("=> Xuat hien loi khi nhap N so phan tu. Vui long nhap lai !\n");
			} else {
				int i;
				float arr[soPhanTu]; // Tao. 1 mang? voi' sô' phân` tu? nhâp. vào bên trên
				for (i = 0; i < soPhanTu; i++) {
					printf("A[%d] = ", i);
					if(scanf("%f", &arr[i]) < 1) { // Giá tri. nhâp. vào phai? là 1 sô' thuc. (float); Nêu' ko se~ báo lôi~
						printf("=> Xuat hien loi khi nhap cac gia tri trong N phan tu. Vui long nhap lai !\n");
			...
			printf("Nhap N: ");
			if(scanf("%f", &giaTriThucHien) < 1) { // Giá tri. nhâp. vào phai? là 1 sô' thuc. (float); Nêu' ko se~ báo lôi~
				printf("=> Xuat hien loi khi nhap gia tri N canh cong. Vui long nhap lai !\n");
			} else {
